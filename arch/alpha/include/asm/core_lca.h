...
__EXTERN_INLINE unsigned int lca_ioread8(const volatile void __iomem *xaddr)
{
...
__EXTERN_INLINE void lca_iowrite8(u8 b, volatile void __iomem *xaddr)
{
	unsigned long addr = (unsigned long) xaddr;
...
__EXTERN_INLINE unsigned int lca_ioread16(const volatile void __iomem *xaddr)
{
	unsigned long addr = (unsigned long) xaddr;
	unsigned long result, base_and_type;
...
__EXTERN_INLINE void lca_iowrite16(u16 b, volatile void __iomem *xaddr)
{
	unsigned long addr = (unsigned long) xaddr;
	unsigned long w, base_and_type;
...
__EXTERN_INLINE unsigned int lca_ioread32(const volatile void __iomem *xaddr)
{
	unsigned long addr = (unsigned long) xaddr;
	if (addr < LCA_DENSE_MEM)
...
__EXTERN_INLINE void lca_iowrite32(u32 b, volatile void __iomem *xaddr)
{
	unsigned long addr = (unsigned long) xaddr;
	if (addr < LCA_DENSE_MEM)
		addr = ((addr - LCA_IO) << 5) + LCA_IO + 0x18;
