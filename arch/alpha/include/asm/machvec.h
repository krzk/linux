...
struct alpha_machine_vector
{
	...
	unsigned int (*mv_ioread8)(const volatile void __iomem *);
	unsigned int (*mv_ioread16)(const volatile void __iomem *);
	unsigned int (*mv_ioread32)(const volatile void __iomem *);

	void (*mv_iowrite8)(u8, volatile void __iomem *);
	void (*mv_iowrite16)(u16, volatile void __iomem *);
	void (*mv_iowrite32)(u32, volatile void __iomem *);
