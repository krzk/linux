...
u64 ioread64_lo_hi(const volatile void __iomem *addr)
{
	return readq(addr);
}
u64 ioread64_hi_lo(const volatile void __iomem *addr)
{
	return readq(addr);
}
...
u64 ioread64be_lo_hi(const volatile void __iomem *addr)
{
	return readq_be(addr);
}
u64 ioread64be_hi_lo(const volatile void __iomem *addr)
{
	return readq_be(addr);
}
...
#ifdef __powerpc64__
void iowrite64(u64 val, volatile void __iomem *addr)
{
	writeq(val, addr);
}
void iowrite64_lo_hi(u64 val, volatile void __iomem *addr)
{
	writeq(val, addr);
}
void iowrite64_hi_lo(u64 val, volatile void __iomem *addr)
{
	writeq(val, addr);
}
void iowrite64be(u64 val, volatile void __iomem *addr)
{
	writeq_be(val, addr);
}
void iowrite64be_lo_hi(u64 val, volatile void __iomem *addr)
{
	writeq_be(val, addr);
}
void iowrite64be_hi_lo(u64 val, volatile void __iomem *addr)
{
	writeq_be(val, addr);
}
