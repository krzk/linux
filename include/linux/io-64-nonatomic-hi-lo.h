...
static inline u64 ioread64_hi_lo(const volatile void __iomem *addr)
{
	u32 low, high;
...
static inline void iowrite64_hi_lo(u64 val, volatile void __iomem *addr)
{
...
static inline u64 ioread64be_hi_lo(const volatile void __iomem *addr)
{
	u32 low, high;
...
static inline void iowrite64be_hi_lo(u64 val, volatile void __iomem *addr)
{
