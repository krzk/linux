...
#define CDC_WSA_RX_INTX_1_MIX_INP0_SEL_MASK	GENMASK(3, 0)
#define CDC_WSA_RX_INTX_1_MIX_INP1_SEL_MASK	GENMASK(7, 4)
#define CDC_WSA_RX_INP_MUX_RX_INT0_CFG1		(0x0104)
#define CDC_WSA_RX_INTX_2_SEL_MASK		GENMASK(3, 0)
#define CDC_WSA_RX_INTX_1_MIX_INP2_SEL_MASK	GENMASK(7, 4)
...
#define CDC_WSA_RX_MIX_TX1_SEL_MASK		GENMASK(7, 4)
#define CDC_WSA_RX_MIX_TX1_SEL_SHFT		4
#define CDC_WSA_RX_MIX_TX0_SEL_MASK		GENMASK(3, 0)
...
#define CDC_WSA_COMPANDER0_CTL8			(0x05A0)
#define CDC_WSA_COMPANDER0_CTL9			(0x05A4)
#define CDC_WSA_COMPANDER0_CTL10		(0x05A8)
#define CDC_WSA_COMPANDER0_CTL11		(0x05AC)
#define CDC_WSA_COMPANDER0_CTL12		(0x05B0)
#define CDC_WSA_COMPANDER0_CTL13		(0x05B4)
#define CDC_WSA_COMPANDER0_CTL14		(0x05B8)
#define CDC_WSA_COMPANDER0_CTL15		(0x05BC)
#define CDC_WSA_COMPANDER0_CTL16		(0x05C0)
#define CDC_WSA_COMPANDER0_CTL17		(0x05C4)
#define CDC_WSA_COMPANDER0_CTL18		(0x05C8)
#define CDC_WSA_COMPANDER0_CTL19		(0x05CC)
#define CDC_WSA_COMPANDER1_CTL0			(0x05E0)
#define CDC_WSA_COMPANDER1_CTL1			(0x05E4)
#define CDC_WSA_COMPANDER1_CTL2			(0x05E8)
#define CDC_WSA_COMPANDER1_CTL3			(0x05EC)
#define CDC_WSA_COMPANDER1_CTL4			(0x05F0)
#define CDC_WSA_COMPANDER1_CTL5			(0x05F4)
#define CDC_WSA_COMPANDER1_CTL6			(0x05F8)
#define CDC_WSA_COMPANDER1_CTL7			(0x05FC)
#define CDC_WSA_COMPANDER1_CTL8			(0x0600)
#define CDC_WSA_COMPANDER1_CTL9			(0x0604)
#define CDC_WSA_COMPANDER1_CTL10		(0x0608)
#define CDC_WSA_COMPANDER1_CTL11		(0x060C)
#define CDC_WSA_COMPANDER1_CTL12		(0x0610)
#define CDC_WSA_COMPANDER1_CTL13		(0x0614)
#define CDC_WSA_COMPANDER1_CTL14		(0x0618)
#define CDC_WSA_COMPANDER1_CTL15		(0x061C)
#define CDC_WSA_COMPANDER1_CTL16		(0x0620)
#define CDC_WSA_COMPANDER1_CTL17		(0x0624)
#define CDC_WSA_COMPANDER1_CTL18		(0x0628)
#define CDC_WSA_COMPANDER1_CTL19		(0x062C)
#define CDC_WSA_SOFTCLIP0_CRC			(0x0640)
#define CDC_WSA_SOFTCLIP_CLK_EN_MASK		BIT(0)
#define CDC_WSA_SOFTCLIP_CLK_ENABLE		BIT(0)
#define CDC_WSA_SOFTCLIP0_SOFTCLIP_CTRL		(0x0644)
#define CDC_WSA_SOFTCLIP_EN_MASK		BIT(0)
#define CDC_WSA_SOFTCLIP_ENABLE			BIT(0)
#define CDC_WSA_SOFTCLIP1_CRC			(0x0660)
#define CDC_WSA_SOFTCLIP1_SOFTCLIP_CTRL		(0x0664)
...
#define WSA_MACRO_RX_COMP_OFFSET 0x60
#define WSA_MACRO_RX_SOFTCLIP_OFFSET 0x20
...
static const struct reg_default wsa_defaults[] = {
	...
	{ CDC_WSA_COMPANDER0_CTL8, 0x00},
	{ CDC_WSA_COMPANDER0_CTL9, 0x00},
	{ CDC_WSA_COMPANDER0_CTL10, 0x06},
	{ CDC_WSA_COMPANDER0_CTL11, 0x12},
	{ CDC_WSA_COMPANDER0_CTL12, 0x1E},
	{ CDC_WSA_COMPANDER0_CTL13, 0x24},
	{ CDC_WSA_COMPANDER0_CTL14, 0x24},
	{ CDC_WSA_COMPANDER0_CTL15, 0x24},
	{ CDC_WSA_COMPANDER0_CTL16, 0x00},
	{ CDC_WSA_COMPANDER0_CTL17, 0x24},
	{ CDC_WSA_COMPANDER0_CTL18, 0x2A},
	{ CDC_WSA_COMPANDER0_CTL19, 0x16},
	...
	{ CDC_WSA_COMPANDER1_CTL8, 0x00},
	{ CDC_WSA_COMPANDER1_CTL9, 0x00},
	{ CDC_WSA_COMPANDER1_CTL10, 0x06},
	{ CDC_WSA_COMPANDER1_CTL11, 0x12},
	{ CDC_WSA_COMPANDER1_CTL12, 0x1E},
	{ CDC_WSA_COMPANDER1_CTL13, 0x24},
	{ CDC_WSA_COMPANDER1_CTL14, 0x24},
	{ CDC_WSA_COMPANDER1_CTL15, 0x24},
	{ CDC_WSA_COMPANDER1_CTL16, 0x00},
	{ CDC_WSA_COMPANDER1_CTL17, 0x24},
	{ CDC_WSA_COMPANDER1_CTL18, 0x2A},
	{ CDC_WSA_COMPANDER1_CTL19, 0x16},
...
static bool wsa_is_rw_register(struct device *dev, unsigned int reg)
{
	...
	case CDC_WSA_COMPANDER0_CTL8:
	case CDC_WSA_COMPANDER0_CTL9:
	case CDC_WSA_COMPANDER0_CTL10:
	case CDC_WSA_COMPANDER0_CTL11:
	case CDC_WSA_COMPANDER0_CTL12:
	case CDC_WSA_COMPANDER0_CTL13:
	case CDC_WSA_COMPANDER0_CTL14:
	case CDC_WSA_COMPANDER0_CTL15:
	case CDC_WSA_COMPANDER0_CTL16:
	case CDC_WSA_COMPANDER0_CTL17:
	case CDC_WSA_COMPANDER0_CTL18:
	case CDC_WSA_COMPANDER0_CTL19:
	...
	case CDC_WSA_COMPANDER1_CTL8:
	case CDC_WSA_COMPANDER1_CTL9:
	case CDC_WSA_COMPANDER1_CTL10:
	case CDC_WSA_COMPANDER1_CTL11:
	case CDC_WSA_COMPANDER1_CTL12:
	case CDC_WSA_COMPANDER1_CTL13:
	case CDC_WSA_COMPANDER1_CTL14:
	case CDC_WSA_COMPANDER1_CTL15:
	case CDC_WSA_COMPANDER1_CTL16:
	case CDC_WSA_COMPANDER1_CTL17:
	case CDC_WSA_COMPANDER1_CTL18:
	case CDC_WSA_COMPANDER1_CTL19:
